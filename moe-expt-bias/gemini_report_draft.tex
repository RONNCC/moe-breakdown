...
\textbf{Llama-2-7B}\textsuperscript{\ddag} & Dense baseline & 1.000 & 7B / 7B & 32 & \textit{(pending)} \\
\bottomrule
\end{tabular}
\end{table}

\noindent{\textsuperscript{\ddag}\small \textit{Llama-2-7B is included as a cross-generation dense baseline (Llama 2 vs.\ Llama 3.1 training generation) to test whether bias diffuseness is stable across Llama generations. Results pending at time of writing.}}
